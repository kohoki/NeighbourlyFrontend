  ...
  return (
    <div className="backgroundColor textColor profile-edit">
      ...
      <form onSubmit={handleUpload} className="edit-profile-image-form">
        <div className="mb-3">
          <input className="form-control" type="file" name="imageUrl" accept="image/png, image/jpg" />
        </div>
        <button className="btn btn-light" type="submit">Upload</button>
      </form>

      <h2>User Details</h2>
      <form onSubmit={handleCreateSubmit} style={{width: "50rem"}} className="edit-profile-form">
      <div className="mb-3">
